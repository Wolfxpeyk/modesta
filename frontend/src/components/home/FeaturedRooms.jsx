  ...
  return (
    <>
      ...
      <section className="bg-cream">
        ...
        {/* Section Header - Elegant Minimal Design */}
        <motion.div
        ...
        >
          <div className="max-w-3xl mx-auto px-4">
            ...
            >
              <div className="w-12 sm:w-16 md:w-20 h-px bg-gradient-to-r from-transparent to-copper"></div>
              <svg className="w-2 h-2 text-copper" fill="currentColor" viewBox="0 0 24 24">
                <circle cx="12" cy="12" r="3" />
              </svg>
              <div className="w-12 sm:w-16 md:w-20 h-px bg-gradient-to-l from-transparent to-copper"></div>
            </motion.div>
            ...
            <motion.h2
              ...
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-playfair font-bold text-forest mb-5 md:mb-6 tracking-wide"
            >
            ...
            <motion.p
              ...
              className="text-sm sm:text-base md:text-lg text-charcoal/60 max-w-2xl mx-auto font-light leading-relaxed italic"
            >
        ...
        {accommodations.map((accommodation, index) => (
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            className="mb-20 md:mb-24 lg:mb-28 last:mb-0 pb-16 md:pb-20 lg:pb-24 last:border-b-0 relative"
          >
            {/* Section Title */}
              ...
              {accommodation.details.map((detail, detailIndex) => (
                ...
                >
                  ...
                  <div className="w-full md:w-1/2 px-4 md:px-0">
                    <p className="text-base text-charcoal/60 font-light leading-relaxed italic">
                      {detail.text}
                    </p>
                  </div>
                </motion.div>
            ...
            {/* Decorative Divider - Only show between sections */}
            {index < accommodations.length - 1 && (
              <motion.div
                ...
                className="mt-16 md:mt-20 lg:mt-24 flex items-center justify-center"
              >
                <div className="w-full max-w-2xl flex items-center gap-4">
                  <div className="flex-1 h-px bg-gradient-to-r from-transparent via-copper/40 to-copper/40" />
                  ...
                  <div className="flex-1 h-px bg-gradient-to-l from-transparent via-copper/40 to-copper/40" />
                </div>
              </motion.div>
            )}
          </motion.div>
